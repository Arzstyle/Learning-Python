...
print("Hasil perhitungan mencari Keliling segitiga dengan sisiA %.0f cm ditambah sisiB %.0f ditambah sisiC %.0f cm adalah %.2f cm." %( sisiA, sisiB, sisiC, rumusKeliling)) 